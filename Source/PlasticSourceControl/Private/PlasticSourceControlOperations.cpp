...
bool FPlasticCheckInWorker::Execute(FPlasticSourceControlCommand& InCommand)
{
	...
	{
		UE_LOG(LogSourceControl, Error, TEXT("FPlasticCheckInWorker: No file to checkin"));
		InCommand.ErrorMessages.Add(TEXT("No file to checkin"));
	}
...
bool FPlasticMarkForAddWorker::Execute(FPlasticSourceControlCommand& InCommand)
{
	...
	{
		UE_LOG(LogSourceControl, Error, TEXT("FPlasticCheckInWorker: No file to checkin"));
		InCommand.ErrorMessages.Add(TEXT("No file to add"));
	}
