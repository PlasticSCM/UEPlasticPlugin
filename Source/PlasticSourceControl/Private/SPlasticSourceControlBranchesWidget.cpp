	...
	[
		...
		[
			...
			[
				...
				.AutoWidth()
				[
					// TODO Button to Open the Branch Explorer
					SNew(SButton)
...
#endif
					.OnClicked(this, &SPlasticSourceControlBranchesWidget::OnOpenBranchExplorerClicked)
					[
						SNew(SHorizontalBox)
						+SHorizontalBox::Slot()
						.AutoWidth()
...
#endif
							.Text(LOCTEXT("OpenBranchExplorer", "Open Branch Explorer"))
						]
					]
				]
			]
...
FReply SPlasticSourceControlBranchesWidget::OnOpenBranchExplorerClicked()
{
