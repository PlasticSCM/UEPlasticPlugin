...
void SUnityVersionControlChangesetsWidget::Construct(const FArguments& InArgs)
{
	ISourceControlModule::Get().RegisterProviderChanged(FSourceControlProviderChanged::FDelegate::CreateSP(this, &SUnityVersionControlChangesetsWidget::OnSourceControlProviderChanged));
	// register for any source control change to detect new local Changesets on check-in
	SourceControlStateChangedDelegateHandle = ISourceControlModule::Get().GetProvider().RegisterSourceControlStateChanged_Handle(FSourceControlStateChanged::FDelegate::CreateSP(this, &SUnityVersionControlChangesetsWidget::HandleSourceControlStateChanged));

	CurrentChangesetId = FUnityVersionControlModule::Get().GetProvider().GetChangesetNumber();

	ChangesetsSearchTextFilter = MakeShared<TTextFilter<const FUnityVersionControlChangeset&>>(TTextFilter<const FUnityVersionControlChangeset&>::FItemToStringArray::CreateSP(this, &SUnityVersionControlChangesetsWidget::PopulateItemSearchStrings));
	ChangesetsSearchTextFilter->OnChanged().AddSP(this, &SUnityVersionControlChangesetsWidget::OnChangesetsRefreshUI);

	FilesSearchTextFilter = MakeShared<TTextFilter<const FUnityVersionControlState&>>(TTextFilter<const FUnityVersionControlState&>::FItemToStringArray::CreateSP(this, &SUnityVersionControlChangesetsWidget::PopulateItemSearchStrings));
	FilesSearchTextFilter->OnChanged().AddSP(this, &SUnityVersionControlChangesetsWidget::OnFilesRefreshUI);
			...
			[
				...
				[
					...
					[
						...
						.OnTextChanged(this, &SUnityVersionControlChangesetsWidget::OnChangesetsSearchTextChanged)
					]
					+SHorizontalBox::Slot()
					.VAlign(VAlign_Center)
					.MaxWidth(125.0f)
					...
					[
						...
						.OnGetMenuContent(this, &SUnityVersionControlChangesetsWidget::BuildFromDateDropDownMenu)
						.ButtonContent()
						[
							SNew(STextBlock)
		...
		[
			...
			[
				...
				[
					...
					.OnTextChanged(this, &SUnityVersionControlChangesetsWidget::OnFilesSearchTextChanged)
				]
				+SVerticalBox::Slot()
				[
					CreateFilesListView()
...
TSharedRef<SWidget> SUnityVersionControlChangesetsWidget::CreateToolBar()
{
#if ENGINE_MAJOR_VERSION >= 5
...
TSharedRef<SWidget> SUnityVersionControlChangesetsWidget::CreateChangesetsListView()
{
	...
	{
		ChangesetsHiddenColumnsList.Add(UnityVersionControlChangesetsListViewColumn::CreatedBy::Id());
	}
	if (!Settings->bShowChangesetDateColumn)
	{
		ChangesetsHiddenColumnsList.Add(UnityVersionControlChangesetsListViewColumn::Date::Id());
	}
	if (!Settings->bShowChangesetCommentColumn)
	{
		ChangesetsHiddenColumnsList.Add(UnityVersionControlChangesetsListViewColumn::Comment::Id());
	}
	if (!Settings->bShowChangesetBranchColumn)
	{
		ChangesetsHiddenColumnsList.Add(UnityVersionControlChangesetsListViewColumn::Branch::Id());
	}

	TSharedRef<SListView<FUnityVersionControlChangesetRef>> ChangesetView = SNew(SListView<FUnityVersionControlChangesetRef>)
		.ListItemsSource(&ChangesetRows)
		.OnGenerateRow(this, &SUnityVersionControlChangesetsWidget::OnGenerateRow)
		.SelectionMode(ESelectionMode::Multi)
		.OnSelectionChanged(this, &SUnityVersionControlChangesetsWidget::OnSelectionChanged)
		.OnContextMenuOpening(this, &SUnityVersionControlChangesetsWidget::OnOpenChangesetContextMenu)
		.OnMouseButtonDoubleClick(this, &SUnityVersionControlChangesetsWidget::OnItemDoubleClicked)
		.OnItemToString_Debug_Lambda([this](FUnityVersionControlChangesetRef Changeset) { return FString::FromInt(Changeset->ChangesetId); })
		.HeaderRow
		(
			SNew(SHeaderRow)
			.CanSelectGeneratedColumn(true)
			.HiddenColumnsList(ChangesetsHiddenColumnsList)
			.OnHiddenColumnsListChanged(this, &SUnityVersionControlChangesetsWidget::OnHiddenColumnsListChanged)

			+SHeaderRow::Column(UnityVersionControlChangesetsListViewColumn::ChangesetId::Id())
			.DefaultLabel(UnityVersionControlChangesetsListViewColumn::ChangesetId::GetDisplayText())
			.DefaultTooltip(UnityVersionControlChangesetsListViewColumn::ChangesetId::GetToolTipText())
			.ShouldGenerateWidget(true) // Ensure the column cannot be hidden (grayed out in the show/hide drop down menu)
			.FillWidth(0.6f)
			.SortPriority(this, &SUnityVersionControlChangesetsWidget::GetChangesetsColumnSortPriority, UnityVersionControlChangesetsListViewColumn::ChangesetId::Id())
			.SortMode(this, &SUnityVersionControlChangesetsWidget::GetChangesetsColumnSortMode, UnityVersionControlChangesetsListViewColumn::ChangesetId::Id())
			.OnSort(this, &SUnityVersionControlChangesetsWidget::OnChangesetsColumnSortModeChanged)

			+SHeaderRow::Column(UnityVersionControlChangesetsListViewColumn::CreatedBy::Id())
			.DefaultLabel(UnityVersionControlChangesetsListViewColumn::CreatedBy::GetDisplayText())
			.DefaultTooltip(UnityVersionControlChangesetsListViewColumn::CreatedBy::GetToolTipText())
			.FillWidth(2.5f)
			.SortPriority(this, &SUnityVersionControlChangesetsWidget::GetChangesetsColumnSortPriority, UnityVersionControlChangesetsListViewColumn::CreatedBy::Id())
			.SortMode(this, &SUnityVersionControlChangesetsWidget::GetChangesetsColumnSortMode, UnityVersionControlChangesetsListViewColumn::CreatedBy::Id())
			.OnSort(this, &SUnityVersionControlChangesetsWidget::OnChangesetsColumnSortModeChanged)

			+SHeaderRow::Column(UnityVersionControlChangesetsListViewColumn::Date::Id())
			.DefaultLabel(UnityVersionControlChangesetsListViewColumn::Date::GetDisplayText())
			.DefaultTooltip(UnityVersionControlChangesetsListViewColumn::Date::GetToolTipText())
			.FillWidth(2.0f)
			.SortPriority(this, &SUnityVersionControlChangesetsWidget::GetChangesetsColumnSortPriority, UnityVersionControlChangesetsListViewColumn::Date::Id())
			.SortMode(this, &SUnityVersionControlChangesetsWidget::GetChangesetsColumnSortMode, UnityVersionControlChangesetsListViewColumn::Date::Id())
			.OnSort(this, &SUnityVersionControlChangesetsWidget::OnChangesetsColumnSortModeChanged)

			+SHeaderRow::Column(UnityVersionControlChangesetsListViewColumn::Comment::Id())
			.DefaultLabel(UnityVersionControlChangesetsListViewColumn::Comment::GetDisplayText())
			.DefaultTooltip(UnityVersionControlChangesetsListViewColumn::Comment::GetToolTipText())
			.FillWidth(5.0f)
			.SortPriority(this, &SUnityVersionControlChangesetsWidget::GetChangesetsColumnSortPriority, UnityVersionControlChangesetsListViewColumn::Comment::Id())
			.SortMode(this, &SUnityVersionControlChangesetsWidget::GetChangesetsColumnSortMode, UnityVersionControlChangesetsListViewColumn::Comment::Id())
			.OnSort(this, &SUnityVersionControlChangesetsWidget::OnChangesetsColumnSortModeChanged)

			+SHeaderRow::Column(UnityVersionControlChangesetsListViewColumn::Branch::Id())
			.DefaultLabel(UnityVersionControlChangesetsListViewColumn::Branch::GetDisplayText())
			.DefaultTooltip(UnityVersionControlChangesetsListViewColumn::Branch::GetToolTipText())
			.FillWidth(2.0f)
			.SortPriority(this, &SUnityVersionControlChangesetsWidget::GetChangesetsColumnSortPriority, UnityVersionControlChangesetsListViewColumn::Branch::Id())
			.SortMode(this, &SUnityVersionControlChangesetsWidget::GetChangesetsColumnSortMode, UnityVersionControlChangesetsListViewColumn::Branch::Id())
			.OnSort(this, &SUnityVersionControlChangesetsWidget::OnChangesetsColumnSortModeChanged)
		);
...
TSharedRef<SWidget> SUnityVersionControlChangesetsWidget::CreateFilesListView()
{
	...
	TSharedRef<SListView<FUnityVersionControlStateRef>> FilesView = SNew(SListView<FUnityVersionControlStateRef>)
		.ListItemsSource(&FileRows)
		.OnGenerateRow(this, &SUnityVersionControlChangesetsWidget::OnGenerateRow)
		.SelectionMode(ESelectionMode::Multi)
		.OnContextMenuOpening(this, &SUnityVersionControlChangesetsWidget::OnOpenFileContextMenu)
#if ENGINE_MAJOR_VERSION == 5 && ENGINE_MINOR_VERSION >= 1
		.OnMouseButtonDoubleClick(this, &SUnityVersionControlChangesetsWidget::OnLocateFileClicked)
#else
		.OnMouseButtonDoubleClick(this, &SUnityVersionControlChangesetsWidget::OnDiffRevisionClicked)
#endif
		.OnItemToString_Debug_Lambda([this](FUnityVersionControlStateRef FileState) { return FileState->LocalFilename; })
		.HeaderRow
		(
			SNew(SHeaderRow)
			.CanSelectGeneratedColumn(true)

			+SHeaderRow::Column(UnityVersionControlChangesetFilesListViewColumn::Icon::Id())
			.DefaultLabel(UnityVersionControlChangesetFilesListViewColumn::Icon::GetDisplayText()) // Displayed in the drop down menu to show/hide columns
			.DefaultTooltip(UnityVersionControlChangesetFilesListViewColumn::Icon::GetToolTipText())
			.ShouldGenerateWidget(true) // Ensure the column cannot be hidden (grayed out in the show/hide drop down menu)
#if ENGINE_MAJOR_VERSION >= 5
			.FillSized(18)
#else
			...
			.SortPriority(this, &SUnityVersionControlChangesetsWidget::GetFilesColumnSortPriority, UnityVersionControlChangesetFilesListViewColumn::Icon::Id())
			.SortMode(this, &SUnityVersionControlChangesetsWidget::GetFilesColumnSortMode, UnityVersionControlChangesetFilesListViewColumn::Icon::Id())
			.OnSort(this, &SUnityVersionControlChangesetsWidget::OnFilesColumnSortModeChanged)
			[
				SNew(SHorizontalBox)
				+SHorizontalBox::Slot()
				.Padding(1, 0)
				[
					...
					.HAlign(HAlign_Center)
					.VAlign(VAlign_Center)
					.Visibility_Lambda([this](){ return GetFilesColumnSortMode(UnityVersionControlChangesetFilesListViewColumn::Icon::Id()) == EColumnSortMode::None ? EVisibility::Visible : EVisibility::Collapsed; })
					[
						SNew(SImage)
#if ENGINE_MAJOR_VERSION == 5 && ENGINE_MINOR_VERSION >= 1
			...
			+SHeaderRow::Column(UnityVersionControlChangesetFilesListViewColumn::Name::Id())
			.DefaultLabel(UnityVersionControlChangesetFilesListViewColumn::Name::GetDisplayText())
			.DefaultTooltip(UnityVersionControlChangesetFilesListViewColumn::Name::GetToolTipText())
			.ShouldGenerateWidget(true) // Ensure the column cannot be hidden (grayed out in the show/hide drop down menu)
			.FillWidth(0.7f)
			.SortPriority(this, &SUnityVersionControlChangesetsWidget::GetFilesColumnSortPriority, UnityVersionControlChangesetFilesListViewColumn::Name::Id())
			.SortMode(this, &SUnityVersionControlChangesetsWidget::GetFilesColumnSortMode, UnityVersionControlChangesetFilesListViewColumn::Name::Id())
			.OnSort(this, &SUnityVersionControlChangesetsWidget::OnFilesColumnSortModeChanged)

			+SHeaderRow::Column(UnityVersionControlChangesetFilesListViewColumn::Path::Id())
			.DefaultLabel(UnityVersionControlChangesetFilesListViewColumn::Path::GetDisplayText())
			.DefaultTooltip(UnityVersionControlChangesetFilesListViewColumn::Path::GetToolTipText())
			.ShouldGenerateWidget(true) // Ensure the column cannot be hidden (grayed out in the show/hide drop down menu)
			.FillWidth(2.0f)
			.SortPriority(this, &SUnityVersionControlChangesetsWidget::GetFilesColumnSortPriority, UnityVersionControlChangesetFilesListViewColumn::Path::Id())
			.SortMode(this, &SUnityVersionControlChangesetsWidget::GetFilesColumnSortMode, UnityVersionControlChangesetFilesListViewColumn::Path::Id())
			.OnSort(this, &SUnityVersionControlChangesetsWidget::OnFilesColumnSortModeChanged)
		);
...
TSharedRef<ITableRow> SUnityVersionControlChangesetsWidget::OnGenerateRow(FUnityVersionControlChangesetRef InChangeset, const TSharedRef<STableViewBase>& OwnerTable)
{
	const bool bIsCurrentChangeset = InChangeset->ChangesetId == CurrentChangesetId;
	return SNew(SUnityVersionControlChangesetRow, OwnerTable)
...
TSharedRef<ITableRow> SUnityVersionControlChangesetsWidget::OnGenerateRow(FUnityVersionControlStateRef InFile, const TSharedRef<STableViewBase>& OwnerTable)
{
	return SNew(SUnityVersionControlChangesetFileRow, OwnerTable)
		.FileToVisualize(InFile)
		.HighlightText_Lambda([this]() { return FilesSearchBox->GetText(); });
}

void SUnityVersionControlChangesetsWidget::OnHiddenColumnsListChanged()
{
	...
	if (ChangesetsListView && ChangesetsListView->GetHeaderRow())
	{
		...
		{
			if (ColumnId == UnityVersionControlChangesetsListViewColumn::CreatedBy::Id())
			{
				Settings->bShowChangesetCreatedByColumn = false;
			}
			else if (ColumnId == UnityVersionControlChangesetsListViewColumn::Date::Id())
			{
				Settings->bShowChangesetDateColumn = false;
			}
			else if (ColumnId == UnityVersionControlChangesetsListViewColumn::Comment::Id())
			{
				Settings->bShowChangesetCommentColumn = false;
			}
			else if (ColumnId == UnityVersionControlChangesetsListViewColumn::Branch::Id())
			{
...
void SUnityVersionControlChangesetsWidget::OnChangesetsSearchTextChanged(const FText& InFilterText)
{
...
void SUnityVersionControlChangesetsWidget::OnFilesSearchTextChanged(const FText& InFilterText)
{
	FilesSearchTextFilter->SetRawFilterText(InFilterText);
	FilesSearchBox->SetError(FilesSearchTextFilter->GetFilterErrorText());
}

void SUnityVersionControlChangesetsWidget::PopulateItemSearchStrings(const FUnityVersionControlChangeset& InItem, TArray<FString>& OutStrings)
{
	InItem.PopulateSearchString(OutStrings);
}

void SUnityVersionControlChangesetsWidget::PopulateItemSearchStrings(const FUnityVersionControlState& InItem, TArray<FString>& OutStrings)
{
	InItem.PopulateSearchString(OutStrings);
}

void SUnityVersionControlChangesetsWidget::OnFromDateChanged(int32 InFromDateInDays)
{
	FromDateInDays = InFromDateInDays;
	bShouldRefresh = true;
}

TSharedRef<SWidget> SUnityVersionControlChangesetsWidget::BuildFromDateDropDownMenu()
{
	FMenuBuilder MenuBuilder(true, nullptr);

	for (const auto & FromDateInDaysValue : FromDateInDaysValues)
	{
		FUIAction MenuAction(FExecuteAction::CreateSP(this, &SUnityVersionControlChangesetsWidget::OnFromDateChanged, FromDateInDaysValue.Key));
...
void SUnityVersionControlChangesetsWidget::OnChangesetsRefreshUI()
{
	TRACE_CPUPROFILER_EVENT_SCOPE(SUnityVersionControlChangesetsWidget::OnChangesetsRefreshUI);

	const int32 ItemCount = SourceControlChangesets.Num();
	ChangesetRows.Empty(ItemCount);
	for (int32 ItemIndex = 0; ItemIndex < ItemCount; ++ItemIndex)
	{
		const FUnityVersionControlChangesetRef& Item = SourceControlChangesets[ItemIndex];
	...
	if (ChangesetsListView)
	{
		...
		{
			if (const FUnityVersionControlChangesetRef* SelectedChangeset = SourceControlChangesets.FindByPredicate([this](const FUnityVersionControlChangesetRef& Changeset) { return Changeset->ChangesetId == SourceSelectedChangeset->ChangesetId; }))
			{
...
void SUnityVersionControlChangesetsWidget::OnFilesRefreshUI()
{
	TRACE_CPUPROFILER_EVENT_SCOPE(SUnityVersionControlChangesetsWidget::OnFilesRefreshUI);
	...
	if (SourceSelectedChangeset.IsValid())
	{
		...
		for (int32 ItemIndex = 0; ItemIndex < ItemCount; ++ItemIndex)
		{
			const FUnityVersionControlStateRef& Item = SourceSelectedChangeset->Files[ItemIndex];
...
EColumnSortPriority::Type SUnityVersionControlChangesetsWidget::GetChangesetsColumnSortPriority(const FName InColumnId) const
{
...
EColumnSortMode::Type SUnityVersionControlChangesetsWidget::GetChangesetsColumnSortMode(const FName InColumnId) const
{
	if (InColumnId == ChangesetsPrimarySortedColumn)
	{
...
void SUnityVersionControlChangesetsWidget::OnChangesetsColumnSortModeChanged(const EColumnSortPriority::Type InSortPriority, const FName& InColumnId, const EColumnSortMode::Type InSortMode)
{
...
void SUnityVersionControlChangesetsWidget::SortChangesetsView()
{
	TRACE_CPUPROFILER_EVENT_SCOPE(SUnityVersionControlChangesetsWidget::SortChangesetsView);
	...
	auto CompareChangesetIds = [](const FUnityVersionControlChangeset* Lhs, const FUnityVersionControlChangeset* Rhs)
	{
		return Lhs->ChangesetId < Rhs->ChangesetId ? -1 : (Lhs->ChangesetId == Rhs->ChangesetId ? 0 : 1);
	};

	auto CompareCreatedBys = [](const FUnityVersionControlChangeset* Lhs, const FUnityVersionControlChangeset* Rhs)
	{
		return FCString::Stricmp(*Lhs->CreatedBy, *Rhs->CreatedBy);
	};

	auto CompareDates = [](const FUnityVersionControlChangeset* Lhs, const FUnityVersionControlChangeset* Rhs)
	{
		return Lhs->Date < Rhs->Date ? -1 : (Lhs->Date == Rhs->Date ? 0 : 1);
	};

	auto CompareComments = [](const FUnityVersionControlChangeset* Lhs, const FUnityVersionControlChangeset* Rhs)
	{
		return FCString::Stricmp(*Lhs->Comment, *Rhs->Comment);
	};

	auto CompareBranches = [](const FUnityVersionControlChangeset* Lhs, const FUnityVersionControlChangeset* Rhs)
	{
	...
	{
		if (ColumnId == UnityVersionControlChangesetsListViewColumn::ChangesetId::Id())
		{
			return TFunction<int32(const FUnityVersionControlChangeset*, const FUnityVersionControlChangeset*)>(CompareChangesetIds);
		}
		else if (ColumnId == UnityVersionControlChangesetsListViewColumn::CreatedBy::Id())
		{
			return TFunction<int32(const FUnityVersionControlChangeset*, const FUnityVersionControlChangeset*)>(CompareCreatedBys);
		}
		else if (ColumnId == UnityVersionControlChangesetsListViewColumn::Date::Id())
		{
			return TFunction<int32(const FUnityVersionControlChangeset*, const FUnityVersionControlChangeset*)>(CompareDates);
		}
		else if (ColumnId == UnityVersionControlChangesetsListViewColumn::Comment::Id())
		{
			return TFunction<int32(const FUnityVersionControlChangeset*, const FUnityVersionControlChangeset*)>(CompareComments);
		}
		else if (ColumnId == UnityVersionControlChangesetsListViewColumn::Branch::Id())
		{
			return TFunction<int32(const FUnityVersionControlChangeset*, const FUnityVersionControlChangeset*)>(CompareBranches);
		}
		else
		{
			checkNoEntry();
			return TFunction<int32(const FUnityVersionControlChangeset*, const FUnityVersionControlChangeset*)>();
		};
	};

	TFunction<int32(const FUnityVersionControlChangeset*, const FUnityVersionControlChangeset*)> PrimaryCompare = GetCompareFunc(ChangesetsPrimarySortedColumn);
	TFunction<int32(const FUnityVersionControlChangeset*, const FUnityVersionControlChangeset*)> SecondaryCompare;
	...
	if (ChangesetsPrimarySortMode == EColumnSortMode::Ascending)
	{
		...
		ChangesetRows.Sort([this, &PrimaryCompare, &SecondaryCompare](const FUnityVersionControlChangesetPtr& Lhs, const FUnityVersionControlChangesetPtr& Rhs)
		{
			int32 Result = PrimaryCompare(static_cast<FUnityVersionControlChangeset*>(Lhs.Get()), static_cast<FUnityVersionControlChangeset*>(Rhs.Get()));
			if (Result < 0)
			{
				return true;
			}
			...
			{
				return SecondaryCompare(static_cast<FUnityVersionControlChangeset*>(Lhs.Get()), static_cast<FUnityVersionControlChangeset*>(Rhs.Get())) < 0;
			}
			else
			{
				return SecondaryCompare(static_cast<FUnityVersionControlChangeset*>(Lhs.Get()), static_cast<FUnityVersionControlChangeset*>(Rhs.Get())) > 0;
...
EColumnSortPriority::Type SUnityVersionControlChangesetsWidget::GetFilesColumnSortPriority(const FName InColumnId) const
{
...
EColumnSortMode::Type SUnityVersionControlChangesetsWidget::GetFilesColumnSortMode(const FName InColumnId) const
{
	if (InColumnId == FilesPrimarySortedColumn)
	{
...
void SUnityVersionControlChangesetsWidget::OnFilesColumnSortModeChanged(const EColumnSortPriority::Type InSortPriority, const FName& InColumnId, const EColumnSortMode::Type InSortMode)
{
	if (InSortPriority == EColumnSortPriority::Primary)
	{
...
void SUnityVersionControlChangesetsWidget::SortFilesView()
{
	TRACE_CPUPROFILER_EVENT_SCOPE(SUnityVersionControlChangesetsWidget::SortFilesView);
	...
	auto CompareIcons = [](const FUnityVersionControlState* Lhs, const FUnityVersionControlState* Rhs)
	{
	...
	auto CompareNames = [](const FUnityVersionControlState* Lhs, const FUnityVersionControlState* Rhs)
	{
		return FCString::Stricmp(*FPaths::GetBaseFilename(Lhs->LocalFilename), *FPaths::GetBaseFilename(Rhs->LocalFilename));
	};

	auto ComparePaths = [](const FUnityVersionControlState* Lhs, const FUnityVersionControlState* Rhs)
	{
	...
	auto GetCompareFunc = [&](const FName& ColumnId)
	{
		if (ColumnId == UnityVersionControlChangesetFilesListViewColumn::Icon::Id())
		{
			return TFunction<int32(const FUnityVersionControlState*, const FUnityVersionControlState*)>(CompareIcons);
		}
		else if (ColumnId == UnityVersionControlChangesetFilesListViewColumn::Name::Id())
		{
			return TFunction<int32(const FUnityVersionControlState*, const FUnityVersionControlState*)>(CompareNames);
		}
		else if (ColumnId == UnityVersionControlChangesetFilesListViewColumn::Path::Id())
		{
			return TFunction<int32(const FUnityVersionControlState*, const FUnityVersionControlState*)>(ComparePaths);
		}
		else
		{
			checkNoEntry();
			return TFunction<int32(const FUnityVersionControlState*, const FUnityVersionControlState*)>();
		};
	};

	TFunction<int32(const FUnityVersionControlState*, const FUnityVersionControlState*)> PrimaryCompare = GetCompareFunc(FilesPrimarySortedColumn);
	TFunction<int32(const FUnityVersionControlState*, const FUnityVersionControlState*)> SecondaryCompare;
	...
	if (FilesPrimarySortMode == EColumnSortMode::Ascending)
	{
		...
		//       with large changelists (7600 items was about 1.8x slower in average measured with Unreal Insight). Because this code runs in the main
		//       thread and can be invoked a lot, the trade off went if favor of speed.
		FileRows.Sort([this, &PrimaryCompare, &SecondaryCompare](const FUnityVersionControlStatePtr& Lhs, const FUnityVersionControlStatePtr& Rhs)
		{
			int32 Result = PrimaryCompare(static_cast<FUnityVersionControlState*>(Lhs.Get()), static_cast<FUnityVersionControlState*>(Rhs.Get()));
			if (Result < 0)
			{
				return true;
			}
			...
			{
				return SecondaryCompare(static_cast<FUnityVersionControlState*>(Lhs.Get()), static_cast<FUnityVersionControlState*>(Rhs.Get())) < 0;
			}
			else
			{
				return SecondaryCompare(static_cast<FUnityVersionControlState*>(Lhs.Get()), static_cast<FUnityVersionControlState*>(Rhs.Get())) > 0;
...
TSharedPtr<SWidget> SUnityVersionControlChangesetsWidget::OnOpenChangesetContextMenu()
{
	const TArray<FUnityVersionControlChangesetRef> SelectedChangesets = ChangesetsListView->GetSelectedItems();
	...
	FUnityVersionControlChangesetPtr SelectedChangeset;
	...
	static const FName MenuName = "UnityVersionControl.ChangesetsContextMenu";
	...
	Section.AddMenuEntry(
		...
		FSlateIcon(),
		FUIAction(
			FExecuteAction::CreateSP(this, &SUnityVersionControlChangesetsWidget::OnDiffChangesetClicked, SelectedChangeset),
	...
	Section.AddMenuEntry(
		...
		FSlateIcon(),
		FUIAction(
			FExecuteAction::CreateSP(this, &SUnityVersionControlChangesetsWidget::OnSwitchToBranchClicked, SelectedChangeset),
			FCanExecuteAction::CreateLambda([bSingleBranchSelected]() { return bSingleBranchSelected; })
		)
	);
	...
	Section.AddMenuEntry(
		...
		FSlateIcon(),
		FUIAction(
			FExecuteAction::CreateSP(this, &SUnityVersionControlChangesetsWidget::OnSwitchToChangesetClicked, SelectedChangeset),
...
static FString ConvertRelativePathToFull(const FUnityVersionControlStatePtr& InSelectedFile)
{
	static const FString& WorkspaceRoot = FUnityVersionControlModule::Get().GetProvider().GetPathToWorkspaceRoot();
	return FPaths::Combine(WorkspaceRoot, InSelectedFile->LocalFilename);
}

static TArray<FString> ConvertRelativePathToFull(const TArray<FUnityVersionControlStateRef>& InSelectedFiles)
{
	TArray<FString> AbsolutePaths;
	AbsolutePaths.Reserve(InSelectedFiles.Num());
	for (const FUnityVersionControlStateRef& InSelectedFile : InSelectedFiles)
	{
...
TSharedPtr<SWidget> SUnityVersionControlChangesetsWidget::OnOpenFileContextMenu()
{
	const TArray<FUnityVersionControlStateRef> SelectedFiles = FilesListView->GetSelectedItems();
	if (SelectedFiles.Num() == 0)
	{
		return nullptr;
	}
	const FUnityVersionControlStateRef SelectedFile = SelectedFiles[0];
	...
	UToolMenus* ToolMenus = UToolMenus::Get();
	static const FName MenuName = "UnityVersionControl.FilesContextMenu";
	if (!ToolMenus->IsMenuRegistered(MenuName))
	{
		UToolMenu* RegisteredMenu = ToolMenus->RegisterMenu(MenuName);
		// Add section so it can be used as insert position for menu extensions
...
#endif
	{
		Section.AddMenuEntry(
			...
			FSlateIcon(),
			FUIAction(
				FExecuteAction::CreateSP(this, &SUnityVersionControlChangesetsWidget::OnDiffRevisionClicked, SelectedFile),
				FCanExecuteAction::CreateLambda([bSingleSelection]() { return bSingleSelection; })
			)
		);
	}
...
#endif
	{
		Section.AddMenuEntry(
			...
			FSlateIcon(),
			FUIAction(
				FExecuteAction::CreateSP(this, &SUnityVersionControlChangesetsWidget::OnDiffAgainstWorkspaceClicked, SelectedFile),
				FCanExecuteAction::CreateLambda([bSingleSelection]() { return bSingleSelection; })
			)
		);
	}
	...
	if (SelectedFile->History.Num() > 0)
	{
		Section.AddMenuEntry(
			...
			FSlateIcon(),
			FUIAction(
				FExecuteAction::CreateSP(this, &SUnityVersionControlChangesetsWidget::OnSaveRevisionClicked, SelectedFile),
				FCanExecuteAction::CreateLambda([bSingleSelection]() { return bSingleSelection; })
			)
		);
	}
	...
	if (SelectedFiles[0]->History.Num() > 0)
	{
		...
		Section.AddMenuEntry(
			...
			FSlateIcon(),
			FUIAction(
				FExecuteAction::CreateSP(this, &SUnityVersionControlChangesetsWidget::OnRevertToRevisionClicked, SelectedFiles),
				FCanExecuteAction()
			)
		);
	}
...
#endif
	{
		...
		Section.AddMenuEntry(
			...
			FSlateIcon(),
			FUIAction(
				FExecuteAction::CreateSP(this, &SUnityVersionControlChangesetsWidget::OnShowHistoryClicked, SelectedFiles),
				FCanExecuteAction()
			)
		);
	}
	...
	if (CurrentWorldLoadedActors.Num() > 0)
	{
		...
		Section.AddMenuEntry(
			...
			FSlateIcon(),
			FUIAction(FExecuteAction::CreateRaw(this, &SUnityVersionControlChangesetsWidget::SelectActors, CurrentWorldLoadedActors)));
	}
#endif
	...
	if (CurrentWorldLoadedActors.Num() > 0)
	{
		Section.AddMenuEntry(
			...
			FSlateIcon(),
			FUIAction(FExecuteAction::CreateRaw(this, &SUnityVersionControlChangesetsWidget::FocusActors, CurrentWorldLoadedActors)));
	}
#endif
	...
	if (SelectedAssets.Num() > 0)
	{
		...
		Section.AddMenuEntry(
			...
			FSlateIcon(),
			FUIAction(FExecuteAction::CreateRaw(this, &SUnityVersionControlChangesetsWidget::BrowseToAssets, SelectedAssets)));
	}
#endif
...
void SUnityVersionControlChangesetsWidget::OnDiffChangesetClicked(FUnityVersionControlChangesetPtr InSelectedChangeset)
{
	if (InSelectedChangeset.IsValid())
	{
		UnityVersionControlUtils::OpenDesktopApplicationForDiff(InSelectedChangeset->ChangesetId);
	}
}

void SUnityVersionControlChangesetsWidget::OnDiffChangesetsClicked(TArray<FUnityVersionControlChangesetRef> InSelectedChangesets)
{
	if (InSelectedChangesets.Num() == 2)
	{
		UnityVersionControlUtils::OpenDesktopApplicationForDiff(InSelectedChangesets[0]->ChangesetId, InSelectedChangesets[1]->ChangesetId);
	}
}

void SUnityVersionControlChangesetsWidget::OnDiffBranchClicked(FUnityVersionControlChangesetPtr InSelectedChangeset)
{
	if (InSelectedChangeset.IsValid())
	{
		UnityVersionControlUtils::OpenDesktopApplicationForDiff(InSelectedChangeset->Branch);
	}
}

void SUnityVersionControlChangesetsWidget::OnSwitchToBranchClicked(FUnityVersionControlChangesetPtr InSelectedChangeset)
{
	if (!InSelectedChangeset.IsValid())
		return;
	...
	if (!Notification.IsInProgress())
	{
		...
		const ECommandResult::Type Result = Provider.Execute(SwitchToBranchOperation, TArray<FString>(), EConcurrency::Asynchronous, FSourceControlOperationComplete::CreateSP(this, &SUnityVersionControlChangesetsWidget::OnSwitchToBranchOperationComplete));
...
void SUnityVersionControlChangesetsWidget::OnSwitchToChangesetClicked(FUnityVersionControlChangesetPtr InSelectedChangeset)
{
	...
	if (Choice == EAppReturnType::Yes)
	{
		if (!Notification.IsInProgress())
		{
			...
			if (!Provider.IsPartialWorkspace())
			{
				...
				const ECommandResult::Type Result = Provider.Execute(SwitchToChangesetOperation, TArray<FString>(), EConcurrency::Asynchronous, FSourceControlOperationComplete::CreateSP(this, &SUnityVersionControlChangesetsWidget::OnSwitchToChangesetOperationComplete));
				if (Result == ECommandResult::Succeeded)
				{
					// Display an ongoing notification during the whole operation (packages will be reloaded at the completion of the operation)
			...
			else
			{
				...
				const ECommandResult::Type Result = Provider.Execute(UpdateToChangesetOperation, TArray<FString>(), EConcurrency::Asynchronous, FSourceControlOperationComplete::CreateSP(this, &SUnityVersionControlChangesetsWidget::OnSwitchToChangesetOperationComplete));
				if (Result == ECommandResult::Succeeded)
				{
					// Display an ongoing notification during the whole operation (packages will be reloaded at the completion of the operation)
...
static UPackage* LoadPackage(const FUnityVersionControlStateRef& InSelectedFile)
{
...
UPackage* LoadPackageForDiff(FUnityVersionControlRevisionRef& InRevision)
{
...
static UObject* GetAssetRevisionObject(FUnityVersionControlRevisionRef& InRevision, FRevisionInfo& OutSelectedRevisionInfo)
{
...
static UObject* GetAssetRevisionObject(const FUnityVersionControlStateRef& InSelectedFile, FRevisionInfo& OutSelectedRevisionInfo)
{
	FUnityVersionControlRevisionRef SelectedRevision = InSelectedFile->History[0];
...
static UObject* GetAssetWorkspaceObject(const FUnityVersionControlStateRef& InSelectedFile)
{
...
void SUnityVersionControlChangesetsWidget::OnLocateFileClicked(FUnityVersionControlStateRef InSelectedFile)
{
...
void SUnityVersionControlChangesetsWidget::OnDiffRevisionClicked(FUnityVersionControlStateRef InSelectedFile)
{
	const FString AbsolutePath = ConvertRelativePathToFull(InSelectedFile);
	...
	if (Provider.Execute(UpdateStatusOperation, PackageFilenames))
	{
		...
		FUnityVersionControlStateRef FileSourceControlState = Provider.GetStateInternal(AbsolutePath);
		...
		if (FileSourceControlState->GetHistorySize() > 0)
		{
			...
			int32 SelectedRevisionIndex = ISourceControlState::INVALID_REVISION;
			{
				...
				{
					FUnityVersionControlRevisionRef Revision = FileSourceControlState->History[i];
			...
			if ((SelectedRevisionIndex != ISourceControlState::INVALID_REVISION) && (SelectedRevisionIndex < FileSourceControlState->History.Num() - 1))
			{
				...
				FUnityVersionControlRevisionRef SelectedRevision = FileSourceControlState->History[SelectedRevisionIndex];
				UObject* SelectedAsset = GetAssetRevisionObject(SelectedRevision, SelectedRevisionInfo);

				FRevisionInfo PreviousRevisionInfo;
				FUnityVersionControlRevisionRef PreviousRevision = FileSourceControlState->History[PreviousRevisionIndex];
...
void SUnityVersionControlChangesetsWidget::OnDiffAgainstWorkspaceClicked(FUnityVersionControlStateRef InSelectedFile)
{
...
void SUnityVersionControlChangesetsWidget::OnSaveRevisionClicked(FUnityVersionControlStateRef InSelectedFile)
{
...
void SUnityVersionControlChangesetsWidget::OnRevertToRevisionClicked(TArray<FUnityVersionControlStateRef> InSelectedFiles)
{
	...
	if (!Notification.IsInProgress())
	{
		...
		FUnityVersionControlRevisionRef SelectedRevision = InSelectedFiles[0]->History[0];
		RevertToRevisionOperation->ChangesetId = SelectedRevision->ChangesetNumber;
		const ECommandResult::Type Result = Provider.Execute(RevertToRevisionOperation, Files, EConcurrency::Asynchronous, FSourceControlOperationComplete::CreateSP(this, &SUnityVersionControlChangesetsWidget::OnRevertToRevisionOperationComplete));
		if (Result == ECommandResult::Succeeded)
		{
			// Display an ongoing notification during the whole operation (packages will be reloaded at the completion of the operation)
...
void SUnityVersionControlChangesetsWidget::OnShowHistoryClicked(TArray<FUnityVersionControlStateRef> InSelectedFiles)
{
...
void SUnityVersionControlChangesetsWidget::SelectActors(const TArray<FAssetData> InActorsToSelect)
{
...
void SUnityVersionControlChangesetsWidget::FocusActors(const TArray<FAssetData> InActorToFocus)
{
...
void SUnityVersionControlChangesetsWidget::BrowseToAssets(const TArray<FAssetData> InAssets)
{
...
void SUnityVersionControlChangesetsWidget::Tick(const FGeometry& AllottedGeometry, const double InCurrentTime, const float InDeltaTime)
{
...
void SUnityVersionControlChangesetsWidget::StartRefreshStatus()
{
	if (!bIsRefreshing)
	{
		bIsRefreshing = true;
...
void SUnityVersionControlChangesetsWidget::TickRefreshStatus(double InDeltaTime)
{
	const int32 RefreshStatusTimeElapsed = static_cast<int32>(FPlatformTime::Seconds() - RefreshStatusStartSecs);
	RefreshStatus = FText::Format(LOCTEXT("UnityVersionControl_RefreshChangesets", "Refreshing changesets... ({0} s)"), FText::AsNumber(RefreshStatusTimeElapsed));
}

void SUnityVersionControlChangesetsWidget::EndRefreshStatus()
{
	bIsRefreshing = false;
	RefreshStatus = FText::GetEmpty();
}

void SUnityVersionControlChangesetsWidget::RequestChangesetsRefresh()
{
	if (!ISourceControlModule::Get().IsEnabled() || (!FUnityVersionControlModule::Get().GetProvider().IsAvailable()))
	{
		return;
	...
	FUnityVersionControlProvider& Provider = FUnityVersionControlModule::Get().GetProvider();
	Provider.Execute(GetChangesetsOperation, EConcurrency::Asynchronous, FSourceControlOperationComplete::CreateSP(this, &SUnityVersionControlChangesetsWidget::OnGetChangesetsOperationComplete));
}

void SUnityVersionControlChangesetsWidget::RequestGetChangesetFiles(const FUnityVersionControlChangesetPtr& InSelectedChangeset)
{
	if (!ISourceControlModule::Get().IsEnabled() || (!FUnityVersionControlModule::Get().GetProvider().IsAvailable()))
	{
		return;
	...
	Provider.Execute(GetChangesetFilesOperation, EConcurrency::Asynchronous, FSourceControlOperationComplete::CreateSP(this, &SUnityVersionControlChangesetsWidget::OnGetChangesetFilesOperationComplete));
}

void SUnityVersionControlChangesetsWidget::OnGetChangesetsOperationComplete(const FSourceControlOperationRef& InOperation, ECommandResult::Type InResult)
{
...
void SUnityVersionControlChangesetsWidget::OnGetChangesetFilesOperationComplete(const FSourceControlOperationRef& InOperation, ECommandResult::Type InResult)
{
...
void SUnityVersionControlChangesetsWidget::OnSwitchToBranchOperationComplete(const FSourceControlOperationRef& InOperation, ECommandResult::Type InResult)
{
	TRACE_CPUPROFILER_EVENT_SCOPE(SUnityVersionControlChangesetsWidget::OnSwitchToBranchOperationComplete);
...
void SUnityVersionControlChangesetsWidget::OnSwitchToChangesetOperationComplete(const FSourceControlOperationRef& InOperation, ECommandResult::Type InResult)
{
	TRACE_CPUPROFILER_EVENT_SCOPE(SUnityVersionControlChangesetsWidget::OnSwitchToChangesetOperationComplete);

	// Reload packages that where updated by the SwitchToChangeset operation (and the current map if needed)
	if (!FUnityVersionControlModule::Get().GetProvider().IsPartialWorkspace())
	{
...
void SUnityVersionControlChangesetsWidget::OnRevertToRevisionOperationComplete(const FSourceControlOperationRef& InOperation, ECommandResult::Type InResult)
{
	TRACE_CPUPROFILER_EVENT_SCOPE(SUnityVersionControlChangesetsWidget::OnRevertToRevisionOperationComplete);
...
void SUnityVersionControlChangesetsWidget::OnSourceControlProviderChanged(ISourceControlProvider& OldProvider, ISourceControlProvider& NewProvider)
{
...
void SUnityVersionControlChangesetsWidget::HandleSourceControlStateChanged()
{
	bShouldRefresh = true;
	if (ChangesetsListView)
	{
...
void SUnityVersionControlChangesetsWidget::OnSelectionChanged(FUnityVersionControlChangesetPtr InSelectedChangeset, ESelectInfo::Type SelectInfo)
{
...
void SUnityVersionControlChangesetsWidget::OnItemDoubleClicked(FUnityVersionControlChangesetRef InSelectedChangeset)
{
	OnDiffChangesetClicked(InSelectedChangeset);
}

FReply SUnityVersionControlChangesetsWidget::OnKeyDown(const FGeometry& MyGeometry, const FKeyEvent& InKeyEvent)
{
