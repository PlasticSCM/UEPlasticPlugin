	...
	[
		...
		[
			...
			[
				...
				.OnCheckStateChanged(this, &SUnityVersionControlCreateBranch::OnCheckedSwitchWorkspace)
				[
					SNew(STextBlock)
		...
		[
			...
			[
				...
				.OnClicked(this, &SUnityVersionControlCreateBranch::CancelClicked)
			]
		]
	];
...
FReply SUnityVersionControlCreateBranch::CreateClicked()
{
...
FReply SUnityVersionControlCreateBranch::CancelClicked()
{
	if (TSharedPtr<SWindow> ParentWindowPin = ParentWindow.Pin())
	{
		ParentWindowPin->RequestDestroyWindow();
...
FReply SUnityVersionControlCreateBranch::OnKeyDown(const FGeometry& MyGeometry, const FKeyEvent& InKeyEvent)
{
