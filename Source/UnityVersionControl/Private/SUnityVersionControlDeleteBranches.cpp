	...
	[
		...
		[
			...
			[
				...
				.OnClicked(this, &SUnityVersionControlDeleteBranches::DeleteClicked)
			]
			+SHorizontalBox::Slot()
			.AutoWidth()
			[
				...
				.OnClicked(this, &SUnityVersionControlDeleteBranches::CancelClicked)
			]
		]
	];
...
FReply SUnityVersionControlDeleteBranches::DeleteClicked()
{
...
FReply SUnityVersionControlDeleteBranches::CancelClicked()
{
	if (TSharedPtr<SWindow> ParentWindowPin = ParentWindow.Pin())
	{
		ParentWindowPin->RequestDestroyWindow();
...
FReply SUnityVersionControlDeleteBranches::OnKeyDown(const FGeometry& MyGeometry, const FKeyEvent& InKeyEvent)
{
