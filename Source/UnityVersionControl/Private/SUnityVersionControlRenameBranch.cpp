...
void SUnityVersionControlRenameBranch::Construct(const FArguments& InArgs)
{
	...
	[
		...
		[
			...
			[
				...
				.IsEnabled(this, &SUnityVersionControlRenameBranch::CanRenameBranch)
				.ToolTipText(this, &SUnityVersionControlRenameBranch::RenameButtonTooltip)
				.OnClicked(this, &SUnityVersionControlRenameBranch::RenamedClicked)
			]
			+SHorizontalBox::Slot()
			.AutoWidth()
			[
				...
				.OnClicked(this, &SUnityVersionControlRenameBranch::CancelClicked)
			]
		]
	];
...
bool SUnityVersionControlRenameBranch::CanRenameBranch() const
{
...
FText SUnityVersionControlRenameBranch::RenameButtonTooltip() const
{
	if (NewBranchName.IsEmpty())
	{
...
FReply SUnityVersionControlRenameBranch::RenamedClicked()
{
	if (TSharedPtr<SUnityVersionControlBranchesWidget> Branches = BranchesWidget.Pin())
	{
...
FReply SUnityVersionControlRenameBranch::CancelClicked()
{
	if (TSharedPtr<SWindow> ParentWindowPin = ParentWindow.Pin())
	{
		ParentWindowPin->RequestDestroyWindow();
...
FReply SUnityVersionControlRenameBranch::OnKeyDown(const FGeometry& MyGeometry, const FKeyEvent& InKeyEvent)
{
