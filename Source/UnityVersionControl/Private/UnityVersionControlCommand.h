...
{
public:
	FUnityVersionControlCommand(const FSourceControlOperationRef& InOperation, const FUnityVersionControlWorkerRef& InWorker, const FSourceControlOperationComplete& InOperationCompleteDelegate = FSourceControlOperationComplete() );
...
public:
	...
	FUnityVersionControlWorkerRef Worker;
