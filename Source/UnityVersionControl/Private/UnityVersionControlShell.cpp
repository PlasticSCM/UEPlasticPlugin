...
namespace UnityVersionControlShell
{
...
{
	TRACE_CPUPROFILER_EVENT_SCOPE(UnityVersionControlShell::_StartBackgroundPlasticShell);
...
{
	TRACE_CPUPROFILER_EVENT_SCOPE(UnityVersionControlShell::_ExitBackgroundCommandLineShell);
...
{
	TRACE_CPUPROFILER_EVENT_SCOPE(UnityVersionControlShell::_RunCommandInternal);
	...
	while (FPlatformProcess::IsProcRunning(ShellProcessHandle))
	{
		...
		if (!Output.IsEmpty())
		{
			TRACE_CPUPROFILER_EVENT_SCOPE(UnityVersionControlShell::_RunCommandInternal::ParseOutput);
		...
		TRACE_CPUPROFILER_EVENT_SCOPE(UnityVersionControlShell::_RunCommandInternal::Sleep);
