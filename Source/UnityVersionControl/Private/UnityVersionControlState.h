...
{
public:
	explicit FUnityVersionControlState(FString&& InLocalFilename)
		: LocalFilename(MoveTemp(InLocalFilename))
	{
	}

	FUnityVersionControlState(FString&& InLocalFilename, EWorkspaceState InWorkspaceState)
		: LocalFilename(MoveTemp(InLocalFilename))
		, WorkspaceState(InWorkspaceState)
	{
	}

	FUnityVersionControlState() = delete;
	FUnityVersionControlState(const FUnityVersionControlState& InState) = delete;
	const FUnityVersionControlState& operator=(const FUnityVersionControlState& InState) = delete;

	FUnityVersionControlState(FUnityVersionControlState&& InState)
	{
...
public:
	...
	TUnityVersionControlHistory History;
