...
{
	FString CommonDir;
	CommonDir = UnityVersionControlUtils::FindCommonDirectory(TEXT(""), TEXT(""));
	TestEqual(TEXT("No common dir"), CommonDir, FString(TEXT("")));
	CommonDir = UnityVersionControlUtils::FindCommonDirectory(TEXT(""), TEXT("/abc/"));
	TestEqual(TEXT("No common dir"), CommonDir, FString(TEXT("")));
	CommonDir = UnityVersionControlUtils::FindCommonDirectory(TEXT("C:/"), TEXT("D:/"));
	TestEqual(TEXT("No common dir"), CommonDir, FString(TEXT("")));
	CommonDir = UnityVersionControlUtils::FindCommonDirectory(TEXT("/ab/c/"), TEXT(""));
	TestEqual(TEXT("No common dir"), CommonDir, FString(TEXT("")));

	CommonDir = UnityVersionControlUtils::FindCommonDirectory(TEXT("/ab/c/"), TEXT("/d/e"));
	TestEqual(TEXT("Root"), CommonDir, FString(TEXT("/")));

	CommonDir = UnityVersionControlUtils::FindCommonDirectory(TEXT("/a/b/c"), TEXT("/a/b/d"));
	TestEqual(TEXT("Common dir"), CommonDir, FString(TEXT("/a/b/")));
	CommonDir = UnityVersionControlUtils::FindCommonDirectory(TEXT("/a/b/ccc"), TEXT("/a/b/cde"));
	TestEqual(TEXT("Common dir"), CommonDir, FString(TEXT("/a/b/")));

	CommonDir = UnityVersionControlUtils::FindCommonDirectory(TEXT("C:/Workspace/Content/Text"), TEXT("C:/Workspace/Content/Textures"));
	...
	CommonDir = UnityVersionControlUtils::FindCommonDirectory(TEXT("C:/Workspace/Content"), TEXT("C:/Workspace/Content/Textures"));
